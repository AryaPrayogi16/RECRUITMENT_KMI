...
return new class extends Migration
{
    ...
    private function getCompleteQuestionData(): array
    {
        return [
            ...
            ['code' => 'D1', 'text' => 'Saya memberikan tekanan kepada orang lain.', 'weights' => ['D' => 0.7358, 'I' => -0.2224, 'S' => -0.8018, 'C' => -0.1825], 'is_core' => true],
            ['code' => 'D2', 'text' => 'Saya memiliki kebutuhan yang kuat akan kekuasaan.', 'weights' => ['D' => 0.6934, 'I' => -0.0433, 'S' => -0.7613, 'C' => -0.412], 'is_core' => true],
            ['code' => 'D3', 'text' => 'Saya berusaha mengungguli orang lain.', 'weights' => ['D' => 0.4749, 'I' => -0.0763, 'S' => -0.6354, 'C' => -0.0928], 'is_core' => true],
            ['code' => 'D4', 'text' => 'Saya selalu mencari cara untuk menghasilkan uang.', 'weights' => ['D' => 0.397, 'I' => -0.0116, 'S' => -0.4254, 'C' => -0.2985], 'is_core' => true],
            ['code' => 'I1', 'text' => 'Saya senang menjadi bagian dari kerumunan yang ramai.', 'weights' => ['D' => 0.142, 'I' => 0.6765, 'S' => -0.3591, 'C' => -0.7434], 'is_core' => true],
            ['code' => 'I2', 'text' => 'Saya ingin orang asing menyukai saya.', 'weights' => ['D' => -0.2084, 'I' => 0.5098, 'S' => 0.095, 'C' => -0.3346], 'is_core' => true],
            ['code' => 'I3', 'text' => 'Saya sering bercanda.', 'weights' => ['D' => -0.013, 'I' => 0.4548, 'S' => -0.1339, 'C' => -0.3701], 'is_core' => true],
            ['code' => 'I4', 'text' => 'Saya membuat banyak suara bising.', 'weights' => ['D' => 0.2961, 'I' => 0.5525, 'S' => -0.5285, 'C' => -0.668], 'is_core' => true],
            ['code' => 'S1', 'text' => 'Saya ragu untuk mengkritik ide orang lain.', 'weights' => ['D' => -0.5269, 'I' => 0.1273, 'S' => 0.6263, 'C' => 0.1406], 'is_core' => true],
            ['code' => 'S2', 'text' => 'Saya menghargai kerjasama daripada kompetisi.', 'weights' => ['D' => -0.4825, 'I' => 0.1843, 'S' => 0.5441, 'C' => 0.0763], 'is_core' => true],
            ['code' => 'S3', 'text' => 'Saya hanya ingin semua orang setara.', 'weights' => ['D' => -0.4421, 'I' => 0.1835, 'S' => 0.4704, 'C' => 0.0569], 'is_core' => true],
            ['code' => 'S4', 'text' => 'Saya jarang membanggakan diri sendiri.', 'weights' => ['D' => -0.2612, 'I' => -0.1909, 'S' => 0.3887, 'C' => 0.3309], 'is_core' => true],
            ['code' => 'C1', 'text' => 'Saya tertutup secara emosional.', 'weights' => ['D' => -0.1637, 'I' => -0.6445, 'S' => 0.3095, 'C' => 0.7542], 'is_core' => true],
            ['code' => 'C2', 'text' => 'Saya membaca tulisan kecil dengan teliti.', 'weights' => ['D' => -0.0746, 'I' => -0.3868, 'S' => -0.0472, 'C' => 0.574], 'is_core' => true],
            ['code' => 'C3', 'text' => 'Saya menyukai keteraturan dan rutinitas.', 'weights' => ['D' => -0.1189, 'I' => -0.4278, 'S' => 0.1641, 'C' => 0.5302], 'is_core' => true],
            ['code' => 'C4', 'text' => 'Reaksi pertama saya terhadap suatu ide adalah melihat kelemahannya.', 'weights' => ['D' => 0.1896, 'I' => -0.4506, 'S' => -0.2252, 'C' => 0.464], 'is_core' => true],
            
            // Additional items from spreadsheet
            ['code' => 'X1', 'text' => 'Saya berlari untuk sampai ke tujuan lebih cepat.', 'weights' => ['D' => 0.3113, 'I' => 0.1123, 'S' => -0.3901, 'C' => -0.3055]],
            ['code' => 'X2', 'text' => 'Saya suka memanggil orang dengan nama belakang mereka.', 'weights' => ['D' => 0.1547, 'I' => -0.0608, 'S' => -0.1903, 'C' => 0.0489]],
            ['code' => 'X3', 'text' => 'Saya membanggakan kebajikan saya.', 'weights' => ['D' => 0.2581, 'I' => 0.1491, 'S' => -0.3749, 'C' => -0.2984]],
            ['code' => 'X4', 'text' => 'Saya menegur orang ketika mereka menceritakan cerita palsu atau berlebihan.', 'weights' => ['D' => 0.3784, 'I' => -0.1437, 'S' => -0.4214, 'C' => -0.0711]],
            ['code' => 'X5', 'text' => 'Saya menuntut pengakuan yang saya layak dapatkan.', 'weights' => ['D' => 0.3417, 'I' => 0.0824, 'S' => -0.4485, 'C' => -0.2974]],
            ['code' => 'X6', 'text' => 'Saya mempercepat laju untuk menghindari disusul.', 'weights' => ['D' => 0.2984, 'I' => 0.0516, 'S' => -0.3386, 'C' => -0.2458]],
            ['code' => 'X7', 'text' => 'Saya tertawa keras.', 'weights' => ['D' => 0.0719, 'I' => 0.3955, 'S' => -0.1513, 'C' => -0.3856]],
            ['code' => 'X8', 'text' => 'Saya bersedia mencoba apa pun sekali.', 'weights' => ['D' => 0.1887, 'I' => 0.2539, 'S' => -0.2494, 'C' => -0.3837]],
            ['code' => 'X9', 'text' => 'Saya mencari petualangan.', 'weights' => ['D' => 0.2522, 'I' => 0.3142, 'S' => -0.3289, 'C' => -0.4874]],
            ['code' => 'X10', 'text' => 'Saya menemukan humor dalam segala hal.', 'weights' => ['D' => -0.0894, 'I' => 0.4086, 'S' => -0.0263, 'C' => -0.3044]],
            ['code' => 'X11', 'text' => 'Saya menyukai pesta besar.', 'weights' => ['D' => 0.1146, 'I' => 0.6706, 'S' => -0.3081, 'C' => -0.7583]],
            ['code' => 'X12', 'text' => 'Saya lebih suka berpartisipasi penuh daripada melihat kehidupan dari pinggir lapangan.', 'weights' => ['D' => 0.2924, 'I' => 0.298, 'S' => -0.3571, 'C' => -0.5336]],
            ['code' => 'X13', 'text' => 'Saya menyampaikan sesuatu secara diplomatis.', 'weights' => ['D' => -0.2556, 'I' => 0.0693, 'S' => 0.2194, 'C' => 0.1649]],
            ['code' => 'X14', 'text' => 'Saya memiliki kata-kata baik untuk semua orang.', 'weights' => ['D' => -0.262, 'I' => 0.3606, 'S' => 0.292, 'C' => -0.2933]],
            ['code' => 'X15', 'text' => 'Saya percaya bahwa orang lain memiliki niat baik.', 'weights' => ['D' => -0.2293, 'I' => 0.2918, 'S' => 0.258, 'C' => -0.1952]],
            ['code' => 'X16', 'text' => 'Saya tidak akan pernah menipu dalam membayar pajak.', 'weights' => ['D' => -0.1754, 'I' => -0.1068, 'S' => 0.2583, 'C' => 0.1953]],
            ['code' => 'X17', 'text' => 'Saya benci terlihat memaksa.', 'weights' => ['D' => -0.56, 'I' => 0.0782, 'S' => 0.5833, 'C' => 0.3251]],
            ['code' => 'X18', 'text' => 'Jika banyak orang menyukai sesuatu, saya biasanya juga akan menyukainya.', 'weights' => ['D' => -0.1811, 'I' => 0.2737, 'S' => 0.2224, 'C' => -0.2238]],
            ['code' => 'X19', 'text' => 'Saya menghindari kesalahan.', 'weights' => ['D' => -0.0641, 'I' => -0.3621, 'S' => 0.0732, 'C' => 0.4943]],
            ['code' => 'X20', 'text' => 'Saya selalu berhati-hati.', 'weights' => ['D' => -0.0101, 'I' => -0.563, 'S' => 0.1324, 'C' => 0.568]],
            ['code' => 'X21', 'text' => 'Saya tidak pernah membuang sampah sembarangan.', 'weights' => ['D' => -0.1036, 'I' => -0.1255, 'S' => 0.1442, 'C' => 0.2213]],
            ['code' => 'X22', 'text' => 'Saya tidak suka basa-basi.', 'weights' => ['D' => 0.1722, 'I' => -0.5368, 'S' => -0.1134, 'C' => 0.47]],
            ['code' => 'X23', 'text' => 'Saya benci ketika orang ingin membuat perubahan tanpa alasan.', 'weights' => ['D' => -0.044, 'I' => -0.2758, 'S' => 0.1065, 'C' => 0.332]],
            ['code' => 'X24', 'text' => 'Saya meninggalkan pesta lebih awal.', 'weights' => ['D' => -0.0149, 'I' => -0.5017, 'S' => 0.1921, 'C' => 0.4962]],
            ['code' => 'X25', 'text' => 'Saya lebih suka berteman dengan orang yang persis seperti saya.', 'weights' => ['D' => -0.0217, 'I' => -0.1721, 'S' => 0.063, 'C' => 0.1753]],
            ['code' => 'X26', 'text' => 'Saya suka melakukan hal-hal baik untuk orang lain meskipun saya tidak mendapat pujian.', 'weights' => ['D' => -0.1855, 'I' => 0.1273, 'S' => 0.399, 'C' => -0.0611]],
            ['code' => 'X27', 'text' => 'Saya selalu ingat ketika seseorang memuji saya.', 'weights' => ['D' => -0.1093, 'I' => 0.1593, 'S' => 0.0827, 'C' => -0.0843]],
            ['code' => 'X28', 'text' => 'Saya tidak suka orang yang berpakaian berantakan.', 'weights' => ['D' => 0.1807, 'I' => -0.1221, 'S' => -0.1881, 'C' => 0.0081]],
            ['code' => 'X29', 'text' => 'Saya kehilangan kesabaran ketika saya lelah.', 'weights' => ['D' => 0.1008, 'I' => -0.1086, 'S' => -0.1646, 'C' => -0.062]],
            ['code' => 'X30', 'text' => 'Saya cemburu dengan persahabatan orang lain.', 'weights' => ['D' => -0.0779, 'I' => -0.0118, 'S' => 0.0933, 'C' => 0.1329]],
            ['code' => 'X31', 'text' => 'Saya pikir beberapa orang memang lebih baik dari yang lain.', 'weights' => ['D' => 0.3109, 'I' => -0.1668, 'S' => -0.3391, 'C' => 0.0091]],
            ['code' => 'A1', 'text' => 'Terkadang saya sulit mengalihkan pandangan dari orang yang menarik.', 'weights' => ['D' => 0.0885, 'I' => 0.1551, 'S' => -0.1354, 'C' => -0.1931]],
            ['code' => 'A2', 'text' => 'Kepercayaan saya sering dikhianati.', 'weights' => ['D' => 0.0362, 'I' => -0.0985, 'S' => -0.0583, 'C' => 0.109]],
            ['code' => 'A3', 'text' => 'Saya bertanya mengapa sesuatu benar-benar terjadi.', 'weights' => ['D' => 0.0887, 'I' => -0.1059, 'S' => -0.163, 'C' => 0.1685]]
        ];
    }
