...
<head>
    ...
    <title>Test DISC 3D - {{ $candidate->candidate_code }}</title>
...
<body class="bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto py-4 px-4">
        ...
        <div class="test-container mb-6">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Test DISC 3D</h1>
    ...
    <div id="loadingOverlay" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
        <div class="bg-white p-8 rounded-lg text-center">
            ...
            <p class="text-sm text-gray-600 mt-2">Mohon tunggu, sedang menghitung profil DISC 3D Anda</p>
        </div>
    </div>
        ...
        function completeTest() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    alert('Test DISC 3D berhasil diselesaikan!');
